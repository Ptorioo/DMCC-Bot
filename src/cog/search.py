...
class Search(commands.Cog):
    ...
    @commands.command(name="songinfo", aliases=["si"], help="")
    async def songinfo(self, ctx, *args):
        ...
        if arg:
            ...
            if len(info) > 1:
                ...
                embed.set_footer(
                    text=f"Search requested by: {str(ctx.author)}",
    ...
    @commands.command(name="midi", aliases=["mid"], help="")
    ...
    @commands.command(name="lyrics", aliases=["lyr"], help="")
